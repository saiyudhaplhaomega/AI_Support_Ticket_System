...
> **Historical platform reference.** The remainder of this file describes the
> earlier classification-service deployment and is retained to preserve the
> recovered project material. It is **not** the Part 1 submission
> architecture. For the current, self-contained Part 1 build, use
> [`docs/00_START_HERE.md`](docs/00_START_HERE.md) and
> [`docs/part1-current-readme.md`](docs/part1-current-readme.md).

> **Earlier interview take-home reference:** the required 1-page Part 1 README
> (architecture decisions, AI output validation, RAG implementation,
> improvements) is at
> [`docs/noavia-part1-readme.md`](docs/noavia-part1-readme.md). This file
> is the broader infra/architecture doc for the underlying reusable
> platform.

For the current interview build sequence, start with
